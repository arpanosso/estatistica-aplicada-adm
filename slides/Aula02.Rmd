...
**Exemplo**: Em uma empresa de componentes eletrônicos, sabe-se, historicamente que a chance de um componente apresentar defeito é de $p = 0{,}10$. Um técnico seleciona $6$ componentes independentes de cada lote e registra o número de componentes defeituosos. Durante um mês de trabalho foram avaliados $500$ lotes, obtendo-se:
...
Seja $t$ o número eventual de ***Unidades Formadoras de Colônia*** (UFC's)  presentes em um volume representado pelo pequeno quadrado observado em um levantamento de isolamento  de  microrganismos  do  solo. Sendo $O$ a frequência observada, registrou-se:
...
$E$ por Poisson	| 8	| 9	| 11	| 13	| 12| 	10| 	7| 	5| 	5| 	80
