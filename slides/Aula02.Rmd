...
$$
Assim, o desvio padrão amostral é definido como:
...
Assim como nas distribuições $z_\alpha$ e $t_\alpha$, $\chi^2_\alpha$ é o valor para o qual a área sob a curva e à sua direita é $\alpha$, cujo valor depende do número de graus de liberdade (veja Tabela a seguir).
