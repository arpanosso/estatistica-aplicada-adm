...
---
0 Qui-quadrado permite compararmos um distribuição de frequências observadas com uma distribuição que poderíamos esperar de acordo com a teoria ou alguma suposição. Assim, o termo **aderência** refere-se à comparação de dados experimentais de frequências observada com a distribuição teórica.

![](img/aderencia-chisqr.png)

---

**Exemplo**: Uma empresa produz componentes eletrônicos. Historicamente, sabe-se que a probabilidade de um componente apresentar defeito é $p = 0{,}10$. Um técnico seleciona $6$ componentes independentes de cada lote e registra o número de componentes defeituosos. Durante um mês de trabalho foram avaliados $500$ lotes, obtendo-se:
...
Nosso teste aderência possui as seguintes hipóteses estatísticas:
...
Frequências observada e esperada para o número de componentes defeituoses em 500 lotes.
...
Para o qui-quadrado de aderência, precisamos tomar cuidado com frequências esperadas pequenas. Se alguma categoria tiver $E<0,05$, devemos agrupar categorias.
...
$\chi_{obs}^2 = \frac{250-265.7205}{265.7205} +\frac{187-177.147}{177.147} +\frac{62-49.2075}{49.2075} +\frac{1-7.925}{7.925} = 10,8549$
...
Seja $t$ o número eventual de ***Unidades Formadoras de Colônia*** (UFC's)  presentes em um volume representado pelo pequeno quadrado observado em um levantamento isolamento  de  microrganismos  do  solo. Sendo $O$ a frequência observada, observou-se:
